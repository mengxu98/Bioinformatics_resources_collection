...
class TestFormatShields(unittest.TestCase):
    def test_format_shields_with_spaces_in_code_language(self):
        ...
        expected_result = "[![Python](https://img.shields.io/badge/-Python-blue)](example.com)"
        self.assertEqual(format_shields(code_language, url_code, shields_color_code), expected_result)

    def test_format_shields_without_spaces_in_code_language(self):
        code_language = "Java"
        url_code = "example.com"
        shields_color_code = "red"
        expected_result = "[![Java](https://img.shields.io/badge/-Java-red)](example.com)"
        self.assertEqual(format_shields(code_language, url_code, shields_color_code), expected_result)
