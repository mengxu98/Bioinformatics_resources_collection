...
class ReadmeUpdater:
    ...
    def _clean_content(self, content_list):
        ...
        content = re.sub(r'(\*\*(?:Latest Highlights|Featured \w+):\*\*\n\|[^\n]*\n\|[^\n]*\n)+', '', content)
...
"""
            ...
            sections = {
                'blogs': ('Blogs', 'Curated blog posts and articles about scRNA-seq and related topics.',
                         '| Field | Title |\n| -- | -- |\n'),
                'books': ('Books', 'Recommended books and learning materials.',
                         '| Field | Title |\n| -- | -- |\n'),
                'databases': ('Databases', 'Useful databases for bioinformatics research.',
                            '| Field | Database | Description | Related paper |\n| -- | -- | -- | -- |\n'),
                'labs': ('Labs', 'Research laboratories and groups in the field.',
                        '| Field | Lab | Masterpiece |\n| -- | -- | -- |\n')
            }
